...
<p align = left> This IA most of time gives good enough maze but sometimes they are pretty "bad". To improve this we can "play" with the parameters of your game like the gamma factor, discount factor, the number of games played, the number of step by game etc..
